...
const (
	...
	G_UNICODE_BREAK_EB  // Emoji Base
	G_UNICODE_BREAK_EM  // Emoji Modifier
	G_UNICODE_BREAK_ZWJ // Zero width joiner
...
func Class(r rune) GUnicodeBreakType {
	...
	case unicode.Is(EB, r):
		return G_UNICODE_BREAK_EB
	case unicode.Is(EM, r):
		return G_UNICODE_BREAK_EM
	...
	case unicode.Is(ZWJ, r):
		return G_UNICODE_BREAK_ZWJ
	}
...
var _AL = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x2761, Hi: 0x2761, Stride: 1},
		{Lo: 0x2765, Hi: 0x2767, Stride: 1},
		...
		{Lo: 0x2e3f, Hi: 0x2e3f, Stride: 1},
		{Lo: 0x2e4b, Hi: 0x2e4b, Stride: 1},
		{Lo: 0x2e4d, Hi: 0x2e4d, Stride: 1},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x11174, Hi: 0x11174, Stride: 1},
		...
		{Lo: 0x1123a, Hi: 0x1123a, Stride: 1},
		{Lo: 0x1123d, Hi: 0x1123d, Stride: 1},
		...
		{Lo: 0x1144f, Hi: 0x1144f, Stride: 1},
		...
		{Lo: 0x11a40, Hi: 0x11a40, Stride: 1},
		{Lo: 0x11a46, Hi: 0x11a46, Stride: 1},
		...
		{Lo: 0x16b45, Hi: 0x16b45, Stride: 1},
		...
		{Lo: 0x1da8b, Hi: 0x1da8b, Stride: 1},
...
var _BA = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1144b, Hi: 0x1144e, Stride: 1},
...
var _BB = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x0c77, Hi: 0x0c77, Stride: 1},
		{Lo: 0x0c84, Hi: 0x0c84, Stride: 1},
		...
		{Lo: 0xa8fc, Hi: 0xa8fc, Stride: 1},
	},
	R32: []unicode.Range32{
		{Lo: 0x11175, Hi: 0x11175, Stride: 1},
		{Lo: 0x111db, Hi: 0x111db, Stride: 1},
		{Lo: 0x115c1, Hi: 0x115c1, Stride: 1},
		{Lo: 0x11660, Hi: 0x1166c, Stride: 1},
		{Lo: 0x119e2, Hi: 0x119e2, Stride: 1},
		{Lo: 0x11a3f, Hi: 0x11a3f, Stride: 1},
		{Lo: 0x11a45, Hi: 0x11a45, Stride: 1},
		{Lo: 0x11a9e, Hi: 0x11aa0, Stride: 1},
...
var _CL = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x2309, Hi: 0x2309, Stride: 1},
		{Lo: 0x230b, Hi: 0x230b, Stride: 1},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x13438, Hi: 0x13438, Stride: 1},
...
var _ID = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1f484, Hi: 0x1f484, Stride: 1},
		{Lo: 0x1f488, Hi: 0x1f48e, Stride: 1},
		{Lo: 0x1f490, Hi: 0x1f490, Stride: 1},
		{Lo: 0x1f492, Hi: 0x1f49f, Stride: 1},
		{Lo: 0x1f4a1, Hi: 0x1f4a1, Stride: 1},
		{Lo: 0x1f4a3, Hi: 0x1f4a3, Stride: 1},
		{Lo: 0x1f4a5, Hi: 0x1f4a9, Stride: 1},
		{Lo: 0x1f4ab, Hi: 0x1f4ae, Stride: 1},
		{Lo: 0x1f4b0, Hi: 0x1f4b0, Stride: 1},
		{Lo: 0x1f4b3, Hi: 0x1f4ff, Stride: 1},
		...
		{Lo: 0x1f9b7, Hi: 0x1f9b7, Stride: 1},
		{Lo: 0x1f9ba, Hi: 0x1f9ba, Stride: 1},
		{Lo: 0x1f9bc, Hi: 0x1f9cc, Stride: 1},
		{Lo: 0x1f9d0, Hi: 0x1f9d0, Stride: 1},
		{Lo: 0x1f9de, Hi: 0x1f9ff, Stride: 1},
...
var _OP = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x2308, Hi: 0x2308, Stride: 1},
		{Lo: 0x230a, Hi: 0x230a, Stride: 1},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x13437, Hi: 0x13437, Stride: 1},
		{Lo: 0x145ce, Hi: 0x145ce, Stride: 1},
...
var _PO = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x20bb, Hi: 0x20bb, Stride: 1},
		{Lo: 0x20be, Hi: 0x20be, Stride: 1},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1ecac, Hi: 0x1ecac, Stride: 1},
		{Lo: 0x1ecb0, Hi: 0x1ecb0, Stride: 1},
	},
	LatinOffset: 3,
}
...
var (
	...
	EB  = _EB  // EB is the set of Unicode characters in line breaking class EB.
	EM  = _EM  // EM is the set of Unicode characters in line breaking class EM.
	...
	ZWJ = _ZWJ // ZWJ is the set of Unicode characters in line breaking class ZWJ.
)

// Range entries: 2108 16-bit, 595 32-bit, 2703 total.
// Range bytes: 12648 16-bit, 7140 32-bit, 19788 total.
