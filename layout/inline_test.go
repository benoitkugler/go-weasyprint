...
var sansFonts = pr.Strings{"DejaVu Sans", "sans"}
...
//     } tu.AssertEqual(t, texts , ["a", "b", "c", "d", "e"], "texts")
// }
...
//       hi</p>`
//     for i := range range(16) {
//         page := renderOnePage(t, htmlSample % i)
//         html := page.Box().Children[0]
//         body := html.Box().Children[0]
//         p, = body.Box().Children
//         lines = p.Box().Children
//     }
// }
//         if i := range (0, 1, 2, 3) {
...
//             textbox1, = line1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "ab", "textbox1")

//             span1 := line2.Box().Children[0]
//             textbox1, = span1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "c", "textbox1")

//             span1, textbox2 = line3.Box().Children
//             textbox1, = span1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "def", "textbox1")
//             tu.AssertEqual(t, textbox2.text , "g", "textbox2")

//             textbox1, = line4.Box().Children
//             tu.AssertEqual(t, textbox1.text , "hi", "textbox1")
//         else if i := range (4, 5, 6, 7, 8) {
//             line1, line2, line3 := unpack3(lines)             textbox1, span1 = line1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "ab ", "textbox1")
//             textbox2, = span1.Box().Children
//             tu.AssertEqual(t, textbox2.text , "c", "textbox2")

//             span1, textbox2 = line2.Box().Children
//             textbox1, = span1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "def", "textbox1")
//             tu.AssertEqual(t, textbox2.text , "g", "textbox2")

//             textbox1, = line3.Box().Children
//             tu.AssertEqual(t, textbox1.text , "hi", "textbox1")
//         else if i := range (9, 10) {
//             line1, line2 = lines
//         }

//             textbox1, span1 = line1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "ab ", "textbox1")
//             textbox2, = span1.Box().Children
//             tu.AssertEqual(t, textbox2.text , "c", "textbox2")
...
//             textbox1, = span1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "def", "textbox1")
//             tu.AssertEqual(t, textbox2.text , "g hi", "textbox2")
//         else if i := range (11, 12, 13) {
//             line1, line2 = lines
//         }

//             textbox1, span1, textbox3 = line1.Box().Children
//             tu.AssertEqual(t, textbox1.text , "ab ", "textbox1")
//             textbox2, = span1.Box().Children
//             tu.AssertEqual(t, textbox2.text , "c def", "textbox2")
//             tu.AssertEqual(t, textbox3.text , "g", "textbox3")

//             textbox1, = line2.Box().Children
//             tu.AssertEqual(t, textbox1.text , "hi", "textbox1")
//         else {
//             line1, = lines
//         }
...
//             textbox2, = span1.Box().Children
//             tu.AssertEqual(t, textbox2.text , "c def", "textbox2")
//             tu.AssertEqual(t, textbox3.text , "g hi", "textbox3")
...
//     line1, line2, line3, line4 = div.Box().Children
//     tu.AssertEqual(t, line1.Box().Children[0].text , line2.Box().Children[0].text , "aaaa", "line1")
//     tu.AssertEqual(t, line3.Box().Children[0].text , "a", "line3")
//     text1, span, text2 = line4.Box().Children
//     tu.AssertEqual(t, text1.text , "[", "text1")
//     tu.AssertEqual(t, text2.text , "]", "text2")
//     tu.AssertEqual(t, span.Box().Children[0].text , "aaa", "span")
// }
...
//     tu.AssertEqual(t, line1.Box().Children[0].text , "aaaa", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].text , "a ", "line2")
//     tu.AssertEqual(t, line2.Box().Children[1].Box().Children[0].text , "b", "line2")
//     tu.AssertEqual(t, line3.Box().Children[0].Box().Children[0].text , "c", "line3")
//     tu.AssertEqual(t, line3.Box().Children[1].text , "d", "line3")
// }
...
//     div, = body.Box().Children
//     line1, line2, line3, line4 = div.Box().Children
//     tu.AssertEqual(t, line1.Box().Children[0].Box().Children[0].text , "aaaa", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].text , "aaaa", "line2")
//     tu.AssertEqual(t, line3.Box().Children[0].Box().Children[0].text , "a a", "line3")
//     tu.AssertEqual(t, line4.Box().Children[0].Box().Children[0].text , "a", "line4")
//     tu.AssertEqual(t, line4.Box().Children[1].Box().Children[0].text , "bc", "line4")
// }
...
//     body := html.Box().Children[0]
//     div, = body.Box().Children
//     line1, line2 = div.Box().Children
//     tu.AssertEqual(t, line1.Box().Children[0].text , "a a", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].text , "/ccc", "line2")
// }
...
//     div, = body.Box().Children
//     line1, line2, line3 := unpack3(div)
//     tu.AssertEqual(t, line1.Box().Children[0].Box().Children[0].Box().Children[0].text , "abc", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].Box().Children[0].text , "d", "line2")
//     tu.AssertEqual(t, line3.Box().Children[0].Box().Children[0].Box().Children[0].text , "e", "line3")
//     tu.AssertEqual(t, line3.Box().Children[1].Box().Children[0].text , "f", "line3")
// }
...
//     tu.AssertEqual(t, line1.Box().Children[0].Box().Children[0].text , (, "line1")
//         "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa bbbbbbbbbbb")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].Box().Children[0].text , "cccc", "line2")
//     tu.AssertEqual(t, line2.Box().Children[1].text , "ddd", "line2")
// }
...
//     body := html.Box().Children[0]
//     p, = body.Box().Children
//     line1, line2, line3, line4 = p.Box().Children
//     tu.AssertEqual(t, line1.Box().Children[0].Box().Children[0].Box().Children[0].text , "xxxxxx YYY", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].Box().Children[0].text , "yyyyyy yyy", "line2")
//     tu.AssertEqual(t, line3.Box().Children[0].Box().Children[0].text , "ZZZZZZ zzzzz", "line3")
//     tu.AssertEqual(t, line4.Box().Children[0].text , ")x", "line4")
// }
...
//     tu.AssertEqual(t, line1.Box().Children[0].text , "line 1", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].text , "123 567", "line2")
//     tu.AssertEqual(t, line3.Box().Children[0].Box().Children[0].text , "90", "line3")
//     tu.AssertEqual(t, line3.Box().Children[1].text , "x", "line3")
// }
...
//     p, = body.Box().Children
//     line1, line2, line3 := unpack3(p)
//     tu.AssertEqual(t, line1.Box().Children[0].text , "123 567 90", "line1")
//     tu.AssertEqual(t, line2.Box().Children[0].Box().Children[0].text , "123 567", "line2")
//     tu.AssertEqual(t, line3.Box().Children[0].Box().Children[0].text , "90", "line3")
//     tu.AssertEqual(t, line3.Box().Children[1].text , "x", "line3")
// }
...
//     body := html.Box().Children[0]
//     paragraph := body.Box().Children[0]
//     lines = list(paragraph.Box().Children)
//     tu.AssertEqual(t, len(lines) , 2, "len")

//     text = " ".join(
//         ("".join(box.text for box := range line.descendants()
...
//     for width, expectedLines := range [(165, 2), (1, 5), (0, 5)]:
//         page = `
//           <style>
...
//         page := renderOnePage(t, page % {"fonts": SANSFONTS, "width": width})
//         html := page.Box().Children[0]
//         body := html.Box().Children[0]
//         paragraph := body.Box().Children[0]
//         lines = list(paragraph.Box().Children)
...
//         refPositionY = lines[0].positionY
//         refPositionX = lines[0].Box().PositionX
//         for line := range lines:
//             tu.AssertEqual(t, refPositionY , line.positionY, "refPositionY")
//             tu.AssertEqual(t, refPositionX , line.Box().PositionX, "refPositionX")
//             for box := range line.Box().Children:
//                 tu.AssertEqual(t, refPositionX , box.Box().PositionX, "refPositionX")
//                 refPositionX += box.Box().Width
//                 tu.AssertEqual(t, refPositionY , box.positionY, "refPositionY")
//             tu.AssertEqual(t, refPositionX - line.Box().PositionX <= line.Box().Width, "refPositionX")
//             refPositionX = line.Box().PositionX
//             refPositionY += line.Box().Height
...
//     lines = pre.Box().Children
//     tu.AssertEqual(t, all(isinstance(line, boxes.LineBox) for line := range lines), "all")
//     tu.AssertEqual(t, len(lines) , 7, "len")
//     tu.AssertEqual(t, [line.Box().Height for line := range lines] , [42] * 7, "[line")
// }
...
//     for width := range [10000, 100, 10, 0]:
//         page := renderOnePage(t, `
...
//         } textParts = []
//         for line := range lines {
//             strong, = line.Box().Children
//             text, = strong.Box().Children
//             textParts.append(text.text)
//         } tu.AssertEqual(t, " ".join(textParts) , (, `)
...
//     for source := range ["a", "  a  ", " \n  \ta", " a\t "] {
//         page := renderOnePage(t, "<p><em>%s</em></p>" % source)
//         html := page.Box().Children[0]
//         body := html.Box().Children[0]
//         p, = body.Box().Children
//         line, = p.Box().Children
//         em, = line.Box().Children
//         text, = em.Box().Children
//         tu.AssertEqual(t, text.text , "a", "source was %r" % (source,), "text")
//     }
// }
//         page := renderOnePage(t,
...
//         body := html.Box().Children[0]
//         p, = body.Box().Children
//         Line1, Line2, line3 = p.Box().Children
//         em, = line3.Box().Children
//         text, = em.Box().Children
//         tu.AssertEqual(t, text.text , "a", "source was %r" % (source,), "text")
...
//     img, = line.Box().Children
//     tu.AssertEqual(t, img.marginTop , 0, "img")
//     tu.AssertEqual(t, img.marginRight , 0, "img")
//     tu.AssertEqual(t, img.marginBottom , 0, "img")
//     tu.AssertEqual(t, img.marginLeft , 0, "img")
// }
...
//     html := page.Box().Children[0]
//     body := html.Box().Children[0]
//     block, = body.Box().Children
//     span, = block.Box().Children
//     tu.AssertEqual(t, span.marginTop != 0, "span")
//     tu.AssertEqual(t, span.marginRight , 0, "span")
//     tu.AssertEqual(t, span.marginBottom != 0, "span")
//     tu.AssertEqual(t, span.marginLeft , 0, "span")
// }
...
//     normal = p1.Box().Width
//     condensed = p2.Box().Width
//     tu.AssertEqual(t, condensed < normal, "condensed")

// @pytest.mark.parametrize("source, linesCount", (
// 	capt := tu.CaptureLogs()
// 	defer capt.AssertNoLogs(t)
...
// ))
// func TestLineCount(t *testing.Tsource, linesCount):
//     page := renderOnePage(t,
...
//     tu.AssertEqual(t, len(lines) , linesCount, "len")
...
//     body := html.Box().Children[0]
//     line, = body.Box().Children
//     span, = line.Box().Children
//     img1, img2 = span.Box().Children
//     tu.AssertEqual(t, img1.Box().Height , 40, "img1")
//     tu.AssertEqual(t, img2.Box().Height , 60, "img2")
//     tu.AssertEqual(t, img1.positionY , 20, "img1")
//     tu.AssertEqual(t, img2.positionY , 0, "img2")
//     // 60px + the descent of the font below the baseline
//     tu.AssertEqual(t, 60 < line.Box().Height < 70, "60")
...
//     tu.AssertEqual(t, img1.Box().Height , 40, "img1")
//     tu.AssertEqual(t, img2.Box().Height , 60, "img2")
//     tu.AssertEqual(t, img1.positionY , 35, "img1")
//     tu.AssertEqual(t, img2.positionY , 0, "img2")
//     tu.AssertEqual(t, line.Box().Height , 75, "line")
//     tu.AssertEqual(t, body.Box().Height , line.Box().Height, "body")
...
//     span2, Whitespace, img2 = span1.Box().Children
//     img1, = span2.Box().Children
//     tu.AssertEqual(t, img1.Box().Height , 40, "img1")
//     tu.AssertEqual(t, img2.Box().Height , 60, "img2")
//     tu.AssertEqual(t, img1.positionY , 35, "img1")
//     tu.AssertEqual(t, img2.positionY , 0, "img2")
...
//     // tu.AssertEqual(t, img1.positionY , 35.2  // 60 - 0.5 * 0.8 * font-size - 40/2, "img1")
//     tu.AssertEqual(t, img2.positionY , 0, "img2")
//     // tu.AssertEqual(t, line.Box().Height , 75.2, "line")
//     tu.AssertEqual(t, body.Box().Height , line.Box().Height, "body")
...
//     line, = body.Box().Children
//     span, = line.Box().Children
//     img1, img2, img3 = span.Box().Children
//     tu.AssertEqual(t, img1.Box().Height , 60, "img1")
//     tu.AssertEqual(t, img2.Box().Height , 40, "img2")
//     tu.AssertEqual(t, img3.Box().Height , 40, "img3")
//     tu.AssertEqual(t, img1.positionY , 0, "img1")
//     tu.AssertEqual(t, img2.positionY , 12  // 20 - 16 * 0.5, "img2")
//     tu.AssertEqual(t, img3.positionY , 28  // 20 + 16 * 0.5, "img3")
//     tu.AssertEqual(t, line.Box().Height , 68, "line")
//     tu.AssertEqual(t, body.Box().Height , line.Box().Height, "body")
...
//     span, = line.Box().Children
//     img1, img2 = span.Box().Children
//     tu.AssertEqual(t, img1.Box().Height , 4, "img1")
//     tu.AssertEqual(t, img2.Box().Height , 4, "img2")
//     tu.AssertEqual(t, img1.positionY , 0, "img1")
//     tu.AssertEqual(t, img2.positionY , 12  // 16 - 4, "img2")
//     tu.AssertEqual(t, line.Box().Height , 16, "line")
//     tu.AssertEqual(t, body.Box().Height , line.Box().Height, "body")
...
//     tu.AssertEqual(t, span1.Box().Height , 16, "span1")
//     tu.AssertEqual(t, span2.Box().Height , 16, "span2")
//     // The line’s strut does ! has "line-height: normal" but the result should
//     // be smaller than 1.5.
//     tu.AssertEqual(t, span1.marginHeight() , 24, "span1")
//     tu.AssertEqual(t, span2.marginHeight() , 24, "span2")
//     tu.AssertEqual(t, line.Box().Height , 24, "line")
...
//     body := html.Box().Children[0]
//     line, = body.Box().Children
//     span, div1 = line.Box().Children
//     tu.AssertEqual(t, line.Box().Height , 178, "line")
//     tu.AssertEqual(t, body.Box().Height , line.Box().Height, "body")
...
//     tu.AssertEqual(t, img1.Box().Height , 40, "img1")
//     tu.AssertEqual(t, img2.Box().Height , 60, "img2")
//     tu.AssertEqual(t, img1.positionY , 138, "img1")
//     tu.AssertEqual(t, img2.positionY , 103, "img2")

//     div2, = div1.Box().Children
//     div3, div4 = div2.Box().Children
//     divLine, = div4.Box().Children
//     divImg1, divImg2 = divLine.Box().Children
//     tu.AssertEqual(t, div1.positionY , 0, "div1")
//     tu.AssertEqual(t, div1.Box().Height , 175, "div1")
//     tu.AssertEqual(t, div3.Box().Height , 100, "div3")
//     tu.AssertEqual(t, divLine.Box().Height , 75, "divLine")
//     tu.AssertEqual(t, divImg1.Box().Height , 40, "divImg1")
//     tu.AssertEqual(t, divImg2.Box().Height , 60, "divImg2")
//     tu.AssertEqual(t, divImg1.positionY , 135, "divImg1")
//     tu.AssertEqual(t, divImg2.positionY , 100, "divImg2")
...
//     line, = body.Box().Children
//     span1 := line.Box().Children[0]
//     img1, img2, span2, span4 = span1.Box().Children
//     img3, span3 = span2.Box().Children
//     img4, = span3.Box().Children
//     img5, = span4.Box().Children
//     tu.AssertEqual(t, body.Box().Height , line.Box().Height, "body")
//     tu.AssertEqual(t, line.Box().Height , 40, "line")
//     tu.AssertEqual(t, img1.positionY , 0, "img1")
//     tu.AssertEqual(t, img2.positionY , 36, "img2")
//     tu.AssertEqual(t, img3.positionY , 6, "img3")
//     tu.AssertEqual(t, img4.positionY , 36, "img4")
//     tu.AssertEqual(t, img5.positionY , 30, "img5")
...
//     span, = line.Box().Children
//     img1, img2 = span.Box().Children
//     tu.AssertEqual(t, img1.positionY , 96, "img1")
//     tu.AssertEqual(t, img2.positionY , 0, "img2")
// }
...
//     html := page.Box().Children[0]
//     body := html.Box().Children[0]
//     line1, = body.Box().Children
//     span, = line1.Box().Children
//     line2, = span.Box().Children
//     img1, = line2.Box().Children
...
//     line1, line2, line3 := unpack3(body)
//     span, = line1.Box().Children
//     tu.AssertEqual(t, span.Box().Width , 16, "span")
//     tu.AssertEqual(t, span.marginWidth() , 16 + 5 + 1, "span")
//     text, br = span.Box().Children
//     tu.AssertEqual(t, text.Box().PositionX , 5 + 1, "text")
//     span, = line2.Box().Children
//     tu.AssertEqual(t, span.Box().Width , 16, "span")
//     tu.AssertEqual(t, span.marginWidth() , 16, "span")
//     text, br = span.Box().Children
//     tu.AssertEqual(t, text.Box().PositionX , 0, "text")
//     span, = line3.Box().Children
//     tu.AssertEqual(t, span.Box().Width , 16, "span")
//     tu.AssertEqual(t, span.marginWidth() , 16 + 5 + 1, "span")
//     text, = span.Box().Children
//     tu.AssertEqual(t, text.Box().PositionX , 0, "text")
...
//     span, = line1.Box().Children
//     tu.AssertEqual(t, span.Box().Width , 16, "span")
//     tu.AssertEqual(t, span.marginWidth() , 16 + 2 * (5 + 1), "span")
//     text, br = span.Box().Children
//     tu.AssertEqual(t, text.Box().PositionX , 5 + 1, "text")
//     span, = line2.Box().Children
//     tu.AssertEqual(t, span.Box().Width , 16, "span")
