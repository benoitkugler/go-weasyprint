...
//     html := page.Box().Children[0]
//     body := html.Box().Children[0]
//     div1, = body.Box().Children
//     div2, div3, div4 = div1.Box().Children
//     tu.AssertEqual(t, div1.Box().Height , 0
//     tu.AssertEqual(t, (div1.Box().PositionX, div1.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, (div2.Box().Width, div2.Box().Height) , (20, 20)
//     tu.AssertEqual(t, (div2.Box().PositionX, div2.Box().PositionY) , (3, 3)
//     tu.AssertEqual(t, (div3.Box().Width, div3.Box().Height) , (20, 20)
//     tu.AssertEqual(t, (div3.Box().PositionX, div3.Box().PositionY) , (0, 3)
//     tu.AssertEqual(t, (div4.Box().Width, div4.Box().Height) , (20, 20)
//     tu.AssertEqual(t, (div4.Box().PositionX, div4.Box().PositionY) , (3, 0)
...
//     body := html.Box().Children[0]
//     div1, = body.Box().Children
//     div2, div3 = div1.Box().Children
//     for div := range (div1, div2, div3) {
//         tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (0, 0)
//         tu.AssertEqual(t, (div.Box().Width, div.Box().Height) , (20, 20)
//     }
// }
...
//     body := html.Box().Children[0]
//     line := body.Box().Children[0]
//     img, span1 = line.Box().Children
//     span2, span3, span4 = span1.Box().Children
//     tu.AssertEqual(t, span1.Box().PositionX , 4
//     tu.AssertEqual(t, (span2.Box().PositionX, span2.Box().PositionY) , (4, 0)
//     tu.AssertEqual(t, (span3.Box().PositionX, span3.Box().PositionY) , (4, 0)
//     tu.AssertEqual(t, span4.Box().PositionX , 4
...
//     body := html.Box().Children[0]
//     line := body.Box().Children[0]
//     img1, span, img2 = line.Box().Children
//     tu.AssertEqual(t, (img1.Box().PositionX, img1.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, (span.Box().PositionX, span.Box().PositionY) , (5, 0)
//     tu.AssertEqual(t, (img2.Box().PositionX, img2.Box().PositionY) , (5, 0)
// }
...
//     img1, span, img2 = line.Box().Children
//     tu.AssertEqual(t, (img1.Box().PositionX, img1.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, (span.Box().PositionX, span.Box().PositionY) , (0, 20)
//     tu.AssertEqual(t, (img2.Box().PositionX, img2.Box().PositionY) , (5, 0)
...
//     div1, = body.Box().Children
//     div2, div3 = div1.Box().Children
//     tu.AssertEqual(t, (div1.Box().PositionX, div1.Box().PositionY) , (1, 5)
//     tu.AssertEqual(t, (div1.Box().Width, div1.Box().Height) , (20, 60)
//     tu.AssertEqual(t, (div1.borderWidth(), div1.borderHeight()) , (40, 86)
//     tu.AssertEqual(t, (div2.Box().PositionX, div2.Box().PositionY) , (11, 28)
//     tu.AssertEqual(t, (div2.Box().Width, div2.Box().Height) , (20, 20)
//     tu.AssertEqual(t, (div3.Box().PositionX, div3.Box().PositionY) , (11, 28)
//     tu.AssertEqual(t, (div3.Box().Width, div3.Box().Height) , (20, 20)
// }
...
//     html := page.Box().Children[0]
//     body := html.Box().Children[0]
//     p1, div, p7 = body.Box().Children
//     p2, p3, p4, p5, p6 = div.Box().Children
//     line := p5.Box().Children[0]
//     span1, = line.Box().Children
//     img, span2, span3 = span1.Box().Children
//     tu.AssertEqual(t, (p1.Box().PositionX, p1.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (0, 20)
//     tu.AssertEqual(t, (p2.Box().PositionX, p2.Box().PositionY) , (0, 20)
//     tu.AssertEqual(t, (p3.Box().PositionX, p3.Box().PositionY) , (5, -5)
//     tu.AssertEqual(t, (p4.Box().PositionX, p4.Box().PositionY) , (0, 40)
...
//     //      = 2000        - 5      - 2 * 10                - 200
//     //      = 1775
//     tu.AssertEqual(t, (p5.Box().PositionX, p5.Box().PositionY) , (915, 1775)
//     tu.AssertEqual(t, (img.Box().PositionX, img.Box().PositionY) , (925, 1785)
//     tu.AssertEqual(t, (span2.Box().PositionX, span2.Box().PositionY) , (929, 1785)
...
//     //         = 1775 + 7             + -10
//     //         = 1772
//     tu.AssertEqual(t, (span3.Box().PositionX, span3.Box().PositionY) , (953, 1772)
//     // p6 y = p4 y + p4 margin height - margin collapsing
//     //      = 40   + 26               - 3
//     //      = 63
//     tu.AssertEqual(t, (p6.Box().PositionX, p6.Box().PositionY) , (0, 63)
//     tu.AssertEqual(t, div.Box().Height , 71  // 20*3 + 2*3 + 8 - 3
//     tu.AssertEqual(t, (p7.Box().PositionX, p7.Box().PositionY) , (0, 91)
...
//     tu.AssertEqual(t, (div.contentBoxX(), div.contentBoxY()) , (15, 10)
//     tu.AssertEqual(t, (div.Box().Width, div.Box().Height) , (10, 20)
// }
...
//     body := html.Box().Children[0]
//     div, = body.Box().Children
//     img1, img2 = div.Box().Children
//     tu.AssertEqual(t, div.Box().Height , 0
//     tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, (img1.Box().PositionX, img1.Box().PositionY) , (10, 10)
//     tu.AssertEqual(t, (img1.Box().Width, img1.Box().Height) , (4, 4)
//     tu.AssertEqual(t, (img2.Box().PositionX, img2.Box().PositionY) , (15, 10)
//     tu.AssertEqual(t, (img2.Box().Width, img2.Box().Height) , (4, 4)

//     // TODO: test the various cases := range absoluteReplaced()
...
//     tu.AssertEqual(t, [c.elementTag for c := range html.Box().Children] , ["body", "p"]
//     html := page2.Box().Children[0]
//     body := html.Box().Children[0]
//     div, = body.Box().Children
//     tu.AssertEqual(t, [c.elementTag for c := range div.Box().Children] , ["p"]
//     html := page3.Box().Children[0]
//     tu.AssertEqual(t, [c.elementTag for c := range html.Box().Children] , ["p", "body"]
// }
...
//     html := page1.Box().Children[0]
//     body := html.Box().Children[0]
//     ul, img, div, article = body.Box().Children
//     marker = ul.Box().Children[0]
//     tu.AssertEqual(t, (ul.Box().PositionX, ul.Box().PositionY) , (80, 10)
//     tu.AssertEqual(t, (img.Box().PositionX, img.Box().PositionY) , (60, 10)
//     tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (40, 10)
//     tu.AssertEqual(t, (article.Box().PositionX, article.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, marker.Box().PositionX , ul.Box().PositionX

//     html := page2.Box().Children[0]
//     ul, img, div, body = html.Box().Children
//     marker = ul.Box().Children[0]
//     tu.AssertEqual(t, (ul.Box().PositionX, ul.Box().PositionY) , (180, 10)
//     tu.AssertEqual(t, (img.Box().PositionX, img.Box().PositionY) , (160, 10)
//     tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (140, 10)
//     tu.AssertEqual(t, (article.Box().PositionX, article.Box().PositionY) , (0, 0)
//     tu.AssertEqual(t, marker.Box().PositionX , ul.Box().PositionX
...
//     html := page1.Box().Children[0]
//     body := html.Box().Children[0]
//     div, section = body.Box().Children
//     tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (15, 10)
//     article, = div.Box().Children
//     tu.AssertEqual(t, (article.Box().PositionX, article.Box().PositionY) , (15, 20)
//     header, = article.Box().Children
//     tu.AssertEqual(t, (header.Box().PositionX, header.Box().PositionY) , (5, 10)
// }
//     html := page2.Box().Children[0]
//     div, body := html.Box().Children[0]
//     tu.AssertEqual(t, (div.Box().PositionX, div.Box().PositionY) , (15, 10)
//     article, = div.Box().Children
//     tu.AssertEqual(t, (article.Box().PositionX, article.Box().PositionY) , (15, 20)
//     header, = article.Box().Children
