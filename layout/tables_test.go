...
// tu.AssertEqual(t, tableWrapper.Box().PositionX ,pr.Float( 0),"")
// tu.AssertEqual(t, table.Box().PositionX ,pr.Float( 0),"")
// tu.AssertEqual(t, td11.Box().PositionX , td21.Box().PositionX ,pr.Float( 1)  ,"") // spacing
// tu.AssertEqual(t, td11.Box().Width , td21.Box().Width ,pr.Float( 4)  ,"") // minimum width
...
// tableWrapper :=  body.Box().Children[0]
// table :=  tableWrapper.Box().Children[0]
//     columnGroup := table.Box().ColumnGroups[0]
...
// tu.AssertEqual(t, tableWrapper.Box().PositionX ,pr.Float( 0),"")
// tu.AssertEqual(t, table.Box().PositionX ,pr.Float( 0),"")
// tu.AssertEqual(t, table.borderLeftWidth ,pr.Float( 5)  ,"") // half of the collapsed 10px border
// tu.AssertEqual(t, td1.Box().PositionX ,pr.Float( 5)  ,"") // border-spacing is ignored
// tu.AssertEqual(t, td1.Box().MarginWidth() ,pr.Float( 30)  ,"") // as <col>
// tu.AssertEqual(t, td1.Box().Width ,pr.Float( 20)  ,"") // 30 - 5 (border-left) - 1 (border-right) - 2*2
// tu.AssertEqual(t, td2.Box().PositionX ,pr.Float( 35),"")
...
// rowGroup :=  table.Box().Children[0]
//     row1, row2  := unpack2( rowGroup)
//     for td := range row1.Box().Children {
...
// 		 checkWidth pr.Float
// 		 positions, widths [2]pr.Float
// 	}{
//         {"500px", "230px", 220, [2]pr.Float{170, 5}, [2]pr.Float{45, 155}},
//         {"530px", "100%", 520, [2]pr.Float{395, 5}, [2]pr.Float{120, 380}},
// 	} {
...
// tu.AssertEqual(t, table.Box().PositionX ,pr.Float( 0),"")
// tu.AssertEqual(t, table.Box().Width , checkWidth,"")
// tu.AssertEqual(t, [child.Box().PositionX for child := range row1.Box().Children] , positions,"")
// tu.AssertEqual(t, [child.Box().PositionX for child := range row2.Box().Children] , positions,"")
// tu.AssertEqual(t, [child.Box().Width for child := range row1.Box().Children] , widths,"")
// tu.AssertEqual(t, [child.Box().Width for child := range row2.Box().Children] , widths,"")
...
// } tu.AssertEqual(t, len(logs) ,pr.Float( 1),"")
// tu.AssertEqual(t, logs[0].startswith("WARNING: This table row has more columns than ","")
...
//     cells = [firstRow.Box().Children, secondRow.Box().Children, thirdRow.Box().Children]
// tu.AssertEqual(t, len(firstRow.Box().Children) ,pr.Float( 2),"")
// tu.AssertEqual(t, len(secondRow.Box().Children) ,pr.Float( 4),"")
//     // Third cell here is completly removed
// tu.AssertEqual(t, len(thirdRow.Box().Children) ,pr.Float( 2),"")
...
// tu.AssertEqual(t, wrapper.contentBoxX() ,pr.Float( 5000)  ,"") // auto margin-left
...
// tu.AssertEqual(t, cells[0][0].borderWidth() ,pr.Float( 3022)  ,"") // 3000 + borders + padding
...
// tu.AssertEqual(t, cells[0][1].borderWidth() ,pr.Float( 6678)  ,"") // 10000 - 3022 - 3*100
...
// tu.AssertEqual(t, cells[1][0].borderWidth() ,pr.Float( 1000)  ,"") // 10% of 10000px
...
// tu.AssertEqual(t, cells[1][1].borderWidth() ,pr.Float( 911)  ,"") // (3022 - 1000 - 2*100) / 2
...
// tu.AssertEqual(t, cells[1][2].borderWidth() ,pr.Float( 911)  ,"") // (3022 - 1000 - 2*100) / 2
...
// tu.AssertEqual(t, cells[1][3].borderWidth() ,pr.Float( 6678),"")
// tu.AssertEqual(t, cells[1][3].Box().Width ,pr.Float( 6656),"")

//     // Same as cells[1][0]
// tu.AssertEqual(t, cells[2][0].Box().PositionX ,pr.Float( 5100),"")
// tu.AssertEqual(t, cells[2][0].borderWidth() ,pr.Float( 1000),"")
...
// tu.AssertEqual(t, cells[2][1].borderWidth() ,pr.Float( 8700)  ,"") // 1000 - 1000 - 3*border-spacing
// tu.AssertEqual(t, cells[2][1].Box().Width ,pr.Float( 8678)  ,"") // 8700 - borders - padding
// tu.AssertEqual(t, cells[2][1].colspan ,pr.Float( 3)  ,"") // truncated to grid width
...
// tu.AssertEqual(t, [row.Box().Height for row := range rowGroup.Box().Children] , [,"")
//         80, 30, 0, 10]
// tu.AssertEqual(t, [row.Box().PositionY for row := range rowGroup.Box().Children] , [,"")
//         // cumulative sum of previous row heights && border-spacings
//         103, 283, 413, 513]
// tu.AssertEqual(t, [[cell.Box().Height for cell := range row.Box().Children],"")
//             for row := range rowGroup.Box().Children] == [
//         [420, 60, 40, 20, 20, 20],
//         [0, 10],
//         [],
//         [0]
//     ]
// tu.AssertEqual(t, [[cell.borderHeight() for cell := range row.Box().Children],"")
//             for row := range rowGroup.Box().Children] == [
//         [420, 80, 80, 80, 80, 80],
//         [30, 30],
//         [],
...
// tu.AssertEqual(t, [[cell.paddingTop for cell := range row.Box().Children],"")
//             for row := range rowGroup.Box().Children] == [
//         [0, 20, 0, 0, 30, 60],
//         [15, 5],
//         [],
//         [10]
//     ]
// tu.AssertEqual(t, [[cell.paddingBottom for cell := range row.Box().Children],"")
//             for row := range rowGroup.Box().Children] == [
//         [0, 0, 40, 60, 30, 0],
//         [15, 15],
//         [],
//         [0]
//     ]
// tu.AssertEqual(t, [[cell.Box().PositionY for cell := range row.Box().Children],"")
//             for row := range rowGroup.Box().Children] == [
...
// tu.AssertEqual(t, table.borderHeight() ,pr.Float( 500),"")
...
//     page := renderOnePage(t,"<html style="display: table">")
...
// ))
// }
// func TestTablePageBreaks(htmt *testing.Tl, rows, positions):
...
// body :=  html.Box().Children[0]
//         if i == 0:
//             bodyChildren = body.Box().Children[1:]  // skip h1
//         else:
// bodyChildren :=  body.Box().Children[0]
//         if ! bodyChildren:
//             rowsPerPage.append(0)
//             continue
//         tableWrapper, = bodyChildren
// table :=  tableWrapper.Box().Children[0]
//         rowsInThisPage = 0
//         for group := range table.Box().Children:
// tu.AssertEqual(t, group.Box().Children, "found an empty table group","")
//             for row := range group.Box().Children:
//                 rowsInThisPage += 1
//                 rowsPositionY.append(row.Box().PositionY)
// cell :=  row.Box().Children[0]
//         rowsPerPage.append(rowsInThisPage)

// tu.AssertEqual(t, rowsPerPage , rows,"")
// tu.AssertEqual(t, rowsPositionY , positions,"")
...
// tableWrapper :=  body.Box().Children[0]
//         if i == 0 {
// tu.AssertEqual(t, tableWrapper.elementTag , "h1","")
//         } else {
// table :=  tableWrapper.Box().Children[0]
//             for group := range table.Box().Children {
// tu.AssertEqual(t, group.Box().Children, "found an empty table group","")
...
//                 } groups.append(rows)
//             }
//         } rowsPerPage.append(groups)
// } tu.AssertEqual(t, rowsPerPage , [,"")
//         [],
//         [["Header"], ["Row 1"], ["Footer"]],
...
// html :=  page.Box().Children[0]
// body :=  html.Box().Children[0]
//         for tableWrapper := range body.Box().Children:
// table :=  tableWrapper.Box().Children[0]
//             for group := range table.Box().Children:
// tu.AssertEqual(t, group.Box().Children, "found an empty table group","")
//                 rows = []
...
//     page1, page2, page3, page4, page5, page6 = renderPages(`
//       <style>
//         @page { size: 1000px }
//         h1 { height: 30px}
//         td { height: 40px }
...
// body :=  html.Box().Children[0]
//     h1, tableWrapper  := unpack2( body)
// table :=  tableWrapper.Box().Children[0]
//     tableGroup1, tableGroup2  := unpack2( table)
// tu.AssertEqual(t, len(tableGroup1.Box().Children) ,pr.Float( 3),"")
// tu.AssertEqual(t, len(tableGroup2.Box().Children) ,pr.Float( 1),"")
// }
...
// table :=  tableWrapper.Box().Children[0]
//     tableGroup1, tableGroup2  := unpack2( table)
// tu.AssertEqual(t, len(tableGroup1.Box().Children) ,pr.Float( 2),"")
// tu.AssertEqual(t, len(tableGroup2.Box().Children) ,pr.Float( 3),"")
...
// tu.AssertEqual(t, len(tableGroup.Box().Children) ,pr.Float( 3),"")
...
// tu.AssertEqual(t, p.elementTag , "p","")
...
// tu.AssertEqual(t, h1.elementTag , "h1","")
...
// table :=  tableWrapper.Box().Children[0]
// tableGroup :=  table.Box().Children[0]
// tu.AssertEqual(t, len(tableGroup.Box().Children) ,pr.Float( 2),"")
...
// ))
// }
// func TestTablePageBreakAvoid(htmt *testing.Tl, rows) {
//     pages := renderPages(t,html)
...
// html :=  page.Box().Children[0]
// body :=  html.Box().Children[0]
//         if body.Box().Children[0].elementTag == "p" {
//             rowsPerPage.append(len(body.Box().Children))
//             continue
//         } else {
// tableWrapper :=  body.Box().Children[0]
// } table :=  tableWrapper.Box().Children[0]
...
// @pytest.mark.parametrize("verticalAlign, tablePositionY", (
// 	capt := tu.CaptureLogs()
// 	defer capt.AssertNoLogs(t)
...
// ))
// }
// func TestInlineTableBaseline(verticalAligt *testing.Tn, tablePositionY) {
...
//     // && the top of the table is thus 8px above the baseline.
//     page := renderOnePage(t,`
//       <style>
//         @font-face { src: url(weasyprint.otf); font-family: weasyprint }
//       </style>
...
// table :=  tableWrapper.Box().Children[0]
// tu.AssertEqual(t, text1.Box().PositionY , text2.Box().PositionY ,pr.Float( 0),"")
// tu.AssertEqual(t, table.Box().Height ,pr.Float( 10) *pr.Float( 2),"")
// tu.AssertEqual(t, abs(table.Box().PositionY - tablePositionY) <pr.Float( 0.1),"")
...
// tu.AssertEqual(t, (h1.contentBoxX(), h1.contentBoxY()) , (20,pr.Float( 20)),"")
// tu.AssertEqual(t, (wrapper.contentBoxX(), wrapper.contentBoxY()) , (20,pr.Float( 50)),"")
// tu.AssertEqual(t, (caption.contentBoxX(), caption.contentBoxY()) , (40,pr.Float( 70)),"")
// tu.AssertEqual(t, (tbody.contentBoxX(), tbody.contentBoxY()) , (20,pr.Float( 100)),"")
// tu.AssertEqual(t, (h2.contentBoxX(), h2.contentBoxY()) , (20,pr.Float( 130)),"")
// }
...
// tu.AssertEqual(t, (h1.contentBoxX(), h1.contentBoxY()) , (20,pr.Float( 20)),"")
// tu.AssertEqual(t, (wrapper.contentBoxX(), wrapper.contentBoxY()) , (20,pr.Float( 50)),"")
// tu.AssertEqual(t, (tbody.contentBoxX(), tbody.contentBoxY()) , (20,pr.Float( 50)),"")
// tu.AssertEqual(t, (caption.contentBoxX(), caption.contentBoxY()) , (40,pr.Float( 80)),"")
// tu.AssertEqual(t, (h2.contentBoxX(), h2.contentBoxY()) , (20,pr.Float( 130)),"")

// @pytest.mark.parametrize("rowsExpected, thead, tfoot, content", (
// 	capt := tu.CaptureLogs()
// 	defer capt.AssertNoLogs(t)
...
//     // We try to render the header && footer on the same page, but it does not
//     // fit. So we try to render the header || the footer on the next one, but
//     // nothing fit either.
//     ([[], []], 110, 110, "<p>content</p>"),
...
// ))
// }
// func TestTableEmptyBody(rowsExpectet *testing.Td, thead, tfoot, content):
//     html = `
//       <style>
//         @page { size: 100px }
//         p { height: 20px }
...
//     ` % (thead, tfoot, content)
//     pages := renderPages(t,html)
// tu.AssertEqual(t, len(pages) , len(rowsExpected),"")
//     for i, page := range enumerate(pages) {
//         rows = []
// html :=  page.Box().Children[0]
// body :=  html.Box().Children[0]
//         tableWrapper = body.Box().Children[-1]
//         if ! tableWrapper.isTableWrapper {
// tu.AssertEqual(t, rows , rowsExpected[i],"")
//             continue
// } table :=  tableWrapper.Box().Children[0]
//         for group := range table.Box().Children {
//             for row := range group.Box().Children {
...
//       </table>
//     `
// tu.AssertEqual(t, len(renderPages(html)) ,pr.Float( 3),"")
