...
type Drawer interface {
	...
	DeviceToUserDistance(dx interface{}, dy interface{})
	...
	Rectangle(x float, y float, width float, height interface{})
	...
	SetAntialias(antialias interface{})
	...
	// offset = 0
	SetDash(dashes interface{}, offset float)
	...
	SetFillRule(fill_rule interface{})
	...
	SetSourceRgb(red interface{}, green interface{}, blue interface{})
	...
	// alpha = 1
	SetSourceRgba(red float, green float, blue float, alpha float)
	...
	UserToDeviceDistance(dx interface{}, dy interface{})
}
