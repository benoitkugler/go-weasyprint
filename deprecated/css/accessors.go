...
func (s Properties) GetTextDecoration() NDecorations {
	return s["text_decoration"].(NDecorations)
}
func (s Properties) SetTextDecoration(v NDecorations) {
	s["text_decoration"] = v
}
...
func (s Properties) GetContentProperties() ContentProperties {
	return s["bookmark_label"].(ContentProperties)
}
func (s Properties) SetContentProperties(v ContentProperties) {
	s["bookmark_label"] = v
}
