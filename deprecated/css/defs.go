...
type Tokens []parser.Token

func (t Tokens) copy() Tokens {
	return append(Tokens{}, t...)
}

func (t Tokens) Copy() CssProperty {
	return t.copy()
}
...
func (n NamedTokens) IsNone() bool {
	return n.Name == "" && n.Tokens == nil
}
...
func (l ContentProperties) Copy() CssProperty {
	return append(ContentProperties{}, l...)
}
