...
var fcLangCharSets = fcLangData.langCharSets
var fcLangCharSetIndices = fcLangData.langIndices
var fcLangCharSetIndicesInv = fcLangData.langIndicesInv

	var fcLangData = struct {
        langCharSets [246]FcLangCharSet
        leaves [725]FcCharLeaf
        numbers [779]uint16
        langIndices [246]byte
        langIndicesInv [246]byte
	}{
[...]FcLangCharSet{
    { "aa",  FcCharSet{1, OFF(0,0), NUM(0,0) } }, // 0 
    { "ab",  FcCharSet{1, OFF(1,1), NUM(1,1) } }, // 1 
    { "af",  FcCharSet{2, OFF(2,2), NUM(2,2) } }, // 2 
    { "ak",  FcCharSet{5, OFF(3,4), NUM(3,4) } }, // 3 
    { "am",  FcCharSet{2, OFF(4,9), NUM(4,9) } }, // 4 
    { "an",  FcCharSet{1, OFF(5,11), NUM(5,11) } }, // 5 
    { "ar",  FcCharSet{1, OFF(6,12), NUM(6,12) } }, // 6 
    { "as",  FcCharSet{1, OFF(7,13), NUM(7,13) } }, // 7 
    { "ast",  FcCharSet{2, OFF(8,14), NUM(8,14) } }, // 8 
    { "av",  FcCharSet{1, OFF(9,16), NUM(9,16) } }, // 9 
    { "ay",  FcCharSet{1, OFF(10,17), NUM(10,17) } }, // 10 
    { "az-az",  FcCharSet{3, OFF(11,18), NUM(11,18) } }, // 11 
    { "az-ir",  FcCharSet{1, OFF(12,21), NUM(12,21) } }, // 12 
    { "ba",  FcCharSet{1, OFF(13,22), NUM(13,22) } }, // 13 
    { "be",  FcCharSet{1, OFF(14,23), NUM(14,23) } }, // 14 
    { "ber-dz",  FcCharSet{4, OFF(15,24), NUM(15,24) } }, // 15 
    { "ber-ma",  FcCharSet{1, OFF(16,28), NUM(16,28) } }, // 16 
    { "bg",  FcCharSet{1, OFF(17,29), NUM(17,29) } }, // 17 
    { "bh",  FcCharSet{1, OFF(18,30), NUM(18,30) } }, // 18 
    { "bho",  FcCharSet{1, OFF(19,30), NUM(19,30) } }, // 19 
    { "bi",  FcCharSet{1, OFF(20,31), NUM(20,31) } }, // 20 
    { "bin",  FcCharSet{3, OFF(21,32), NUM(21,32) } }, // 21 
    { "bm",  FcCharSet{3, OFF(22,35), NUM(22,35) } }, // 22 
    { "bn",  FcCharSet{1, OFF(23,38), NUM(23,38) } }, // 23 
    { "bo",  FcCharSet{1, OFF(24,39), NUM(24,39) } }, // 24 
    { "br",  FcCharSet{1, OFF(25,40), NUM(25,40) } }, // 25 
    { "brx",  FcCharSet{1, OFF(26,41), NUM(26,41) } }, // 26 
    { "bs",  FcCharSet{2, OFF(27,42), NUM(27,42) } }, // 27 
    { "bua",  FcCharSet{1, OFF(28,44), NUM(28,44) } }, // 28 
    { "byn",  FcCharSet{2, OFF(29,45), NUM(29,45) } }, // 29 
    { "ca",  FcCharSet{2, OFF(30,47), NUM(30,47) } }, // 30 
    { "ce",  FcCharSet{1, OFF(31,16), NUM(31,16) } }, // 31 
    { "ch",  FcCharSet{1, OFF(32,49), NUM(32,49) } }, // 32 
    { "chm",  FcCharSet{1, OFF(33,50), NUM(33,50) } }, // 33 
    { "chr",  FcCharSet{1, OFF(34,51), NUM(34,51) } }, // 34 
    { "co",  FcCharSet{2, OFF(35,52), NUM(35,52) } }, // 35 
    { "crh",  FcCharSet{2, OFF(36,54), NUM(36,54) } }, // 36 
    { "cs",  FcCharSet{2, OFF(37,56), NUM(37,56) } }, // 37 
    { "csb",  FcCharSet{2, OFF(38,58), NUM(38,58) } }, // 38 
    { "cu",  FcCharSet{1, OFF(39,60), NUM(39,60) } }, // 39 
    { "cv",  FcCharSet{2, OFF(40,61), NUM(40,61) } }, // 40 
    { "cy",  FcCharSet{3, OFF(41,63), NUM(41,63) } }, // 41 
    { "da",  FcCharSet{1, OFF(42,66), NUM(42,66) } }, // 42 
    { "de",  FcCharSet{1, OFF(43,67), NUM(43,67) } }, // 43 
    { "doi",  FcCharSet{1, OFF(44,68), NUM(44,68) } }, // 44 
    { "dv",  FcCharSet{1, OFF(45,69), NUM(45,69) } }, // 45 
    { "dz",  FcCharSet{1, OFF(46,39), NUM(46,39) } }, // 46 
    { "ee",  FcCharSet{4, OFF(47,70), NUM(47,70) } }, // 47 
    { "el",  FcCharSet{1, OFF(48,74), NUM(48,74) } }, // 48 
    { "en",  FcCharSet{1, OFF(49,75), NUM(49,75) } }, // 49 
    { "eo",  FcCharSet{2, OFF(50,76), NUM(50,76) } }, // 50 
    { "es",  FcCharSet{1, OFF(51,11), NUM(51,11) } }, // 51 
    { "et",  FcCharSet{2, OFF(52,78), NUM(52,78) } }, // 52 
    { "eu",  FcCharSet{1, OFF(53,80), NUM(53,80) } }, // 53 
    { "fa",  FcCharSet{1, OFF(54,21), NUM(54,21) } }, // 54 
    { "fat",  FcCharSet{5, OFF(55,4), NUM(55,4) } }, // 55 
    { "ff",  FcCharSet{3, OFF(56,81), NUM(56,81) } }, // 56 
    { "fi",  FcCharSet{2, OFF(57,84), NUM(57,84) } }, // 57 
    { "fil",  FcCharSet{1, OFF(58,86), NUM(58,86) } }, // 58 
    { "fj",  FcCharSet{1, OFF(59,87), NUM(59,87) } }, // 59 
    { "fo",  FcCharSet{1, OFF(60,88), NUM(60,88) } }, // 60 
    { "fr",  FcCharSet{2, OFF(61,52), NUM(61,52) } }, // 61 
    { "fur",  FcCharSet{1, OFF(62,89), NUM(62,89) } }, // 62 
    { "fy",  FcCharSet{1, OFF(63,90), NUM(63,90) } }, // 63 
    { "ga",  FcCharSet{3, OFF(64,91), NUM(64,91) } }, // 64 
    { "gd",  FcCharSet{1, OFF(65,94), NUM(65,94) } }, // 65 
    { "gez",  FcCharSet{2, OFF(66,95), NUM(66,95) } }, // 66 
    { "gl",  FcCharSet{1, OFF(67,11), NUM(67,11) } }, // 67 
    { "gn",  FcCharSet{3, OFF(68,97), NUM(68,97) } }, // 68 
    { "gu",  FcCharSet{1, OFF(69,100), NUM(69,100) } }, // 69 
    { "gv",  FcCharSet{1, OFF(70,101), NUM(70,101) } }, // 70 
    { "ha",  FcCharSet{3, OFF(71,102), NUM(71,102) } }, // 71 
    { "haw",  FcCharSet{3, OFF(72,105), NUM(72,105) } }, // 72 
    { "he",  FcCharSet{1, OFF(73,108), NUM(73,108) } }, // 73 
    { "hi",  FcCharSet{1, OFF(74,30), NUM(74,30) } }, // 74 
    { "hne",  FcCharSet{1, OFF(75,30), NUM(75,30) } }, // 75 
    { "ho",  FcCharSet{1, OFF(76,87), NUM(76,87) } }, // 76 
    { "hr",  FcCharSet{2, OFF(77,42), NUM(77,42) } }, // 77 
    { "hsb",  FcCharSet{2, OFF(78,109), NUM(78,109) } }, // 78 
    { "ht",  FcCharSet{1, OFF(79,111), NUM(79,111) } }, // 79 
    { "hu",  FcCharSet{2, OFF(80,112), NUM(80,112) } }, // 80 
    { "hy",  FcCharSet{1, OFF(81,114), NUM(81,114) } }, // 81 
    { "hz",  FcCharSet{3, OFF(82,115), NUM(82,115) } }, // 82 
    { "ia",  FcCharSet{1, OFF(83,87), NUM(83,87) } }, // 83 
    { "id",  FcCharSet{1, OFF(84,118), NUM(84,118) } }, // 84 
    { "ie",  FcCharSet{1, OFF(85,87), NUM(85,87) } }, // 85 
    { "ig",  FcCharSet{2, OFF(86,119), NUM(86,119) } }, // 86 
    { "ii",  FcCharSet{5, OFF(87,121), NUM(87,121) } }, // 87 
    { "ik",  FcCharSet{1, OFF(88,126), NUM(88,126) } }, // 88 
    { "io",  FcCharSet{1, OFF(89,87), NUM(89,87) } }, // 89 
    { "is",  FcCharSet{1, OFF(90,127), NUM(90,127) } }, // 90 
    { "it",  FcCharSet{1, OFF(91,128), NUM(91,128) } }, // 91 
    { "iu",  FcCharSet{3, OFF(92,129), NUM(92,129) } }, // 92 
    { "ja",  FcCharSet{83, OFF(93,132), NUM(93,132) } }, // 93 
    { "jv",  FcCharSet{1, OFF(94,215), NUM(94,215) } }, // 94 
    { "ka",  FcCharSet{1, OFF(95,216), NUM(95,216) } }, // 95 
    { "kaa",  FcCharSet{1, OFF(96,217), NUM(96,217) } }, // 96 
    { "kab",  FcCharSet{4, OFF(97,24), NUM(97,24) } }, // 97 
    { "ki",  FcCharSet{2, OFF(98,218), NUM(98,218) } }, // 98 
    { "kj",  FcCharSet{1, OFF(99,87), NUM(99,87) } }, // 99 
    { "kk",  FcCharSet{1, OFF(100,220), NUM(100,220) } }, // 100 
    { "kl",  FcCharSet{2, OFF(101,221), NUM(101,221) } }, // 101 
    { "km",  FcCharSet{1, OFF(102,223), NUM(102,223) } }, // 102 
    { "kn",  FcCharSet{1, OFF(103,224), NUM(103,224) } }, // 103 
    { "ko",  FcCharSet{45, OFF(104,225), NUM(104,225) } }, // 104 
    { "kok",  FcCharSet{1, OFF(105,30), NUM(105,30) } }, // 105 
    { "kr",  FcCharSet{3, OFF(106,270), NUM(106,270) } }, // 106 
    { "ks",  FcCharSet{1, OFF(107,273), NUM(107,273) } }, // 107 
    { "ku-am",  FcCharSet{2, OFF(108,274), NUM(108,274) } }, // 108 
    { "ku-iq",  FcCharSet{1, OFF(109,276), NUM(109,276) } }, // 109 
    { "ku-ir",  FcCharSet{1, OFF(110,276), NUM(110,276) } }, // 110 
    { "ku-tr",  FcCharSet{2, OFF(111,277), NUM(111,277) } }, // 111 
    { "kum",  FcCharSet{1, OFF(112,279), NUM(112,279) } }, // 112 
    { "kv",  FcCharSet{1, OFF(113,280), NUM(113,280) } }, // 113 
    { "kw",  FcCharSet{3, OFF(114,281), NUM(114,281) } }, // 114 
    { "kwm",  FcCharSet{1, OFF(115,87), NUM(115,87) } }, // 115 
    { "ky",  FcCharSet{1, OFF(116,284), NUM(116,284) } }, // 116 
    { "la",  FcCharSet{2, OFF(117,285), NUM(117,285) } }, // 117 
    { "lah",  FcCharSet{1, OFF(118,287), NUM(118,287) } }, // 118 
    { "lb",  FcCharSet{1, OFF(119,288), NUM(119,288) } }, // 119 
    { "lez",  FcCharSet{1, OFF(120,16), NUM(120,16) } }, // 120 
    { "lg",  FcCharSet{2, OFF(121,289), NUM(121,289) } }, // 121 
    { "li",  FcCharSet{1, OFF(122,291), NUM(122,291) } }, // 122 
    { "ln",  FcCharSet{4, OFF(123,292), NUM(123,292) } }, // 123 
    { "lo",  FcCharSet{1, OFF(124,296), NUM(124,296) } }, // 124 
    { "lt",  FcCharSet{2, OFF(125,297), NUM(125,297) } }, // 125 
    { "lv",  FcCharSet{2, OFF(126,299), NUM(126,299) } }, // 126 
    { "mai",  FcCharSet{1, OFF(127,30), NUM(127,30) } }, // 127 
    { "mg",  FcCharSet{1, OFF(128,301), NUM(128,301) } }, // 128 
    { "mh",  FcCharSet{2, OFF(129,302), NUM(129,302) } }, // 129 
    { "mi",  FcCharSet{3, OFF(130,304), NUM(130,304) } }, // 130 
    { "mk",  FcCharSet{1, OFF(131,307), NUM(131,307) } }, // 131 
    { "ml",  FcCharSet{1, OFF(132,308), NUM(132,308) } }, // 132 
    { "mn-cn",  FcCharSet{1, OFF(133,309), NUM(133,309) } }, // 133 
    { "mn-mn",  FcCharSet{1, OFF(134,310), NUM(134,310) } }, // 134 
    { "mni",  FcCharSet{1, OFF(135,311), NUM(135,311) } }, // 135 
    { "mo",  FcCharSet{4, OFF(136,312), NUM(136,312) } }, // 136 
    { "mr",  FcCharSet{1, OFF(137,30), NUM(137,30) } }, // 137 
    { "ms",  FcCharSet{1, OFF(138,87), NUM(138,87) } }, // 138 
    { "mt",  FcCharSet{2, OFF(139,316), NUM(139,316) } }, // 139 
    { "my",  FcCharSet{1, OFF(140,318), NUM(140,318) } }, // 140 
    { "na",  FcCharSet{2, OFF(141,319), NUM(141,319) } }, // 141 
    { "nb",  FcCharSet{1, OFF(142,321), NUM(142,321) } }, // 142 
    { "nds",  FcCharSet{1, OFF(143,67), NUM(143,67) } }, // 143 
    { "ne",  FcCharSet{1, OFF(144,322), NUM(144,322) } }, // 144 
    { "ng",  FcCharSet{1, OFF(145,87), NUM(145,87) } }, // 145 
    { "nl",  FcCharSet{1, OFF(146,323), NUM(146,323) } }, // 146 
    { "nn",  FcCharSet{1, OFF(147,324), NUM(147,324) } }, // 147 
    { "no",  FcCharSet{1, OFF(148,321), NUM(148,321) } }, // 148 
    { "nqo",  FcCharSet{1, OFF(149,325), NUM(149,325) } }, // 149 
    { "nr",  FcCharSet{1, OFF(150,87), NUM(150,87) } }, // 150 
    { "nso",  FcCharSet{2, OFF(151,326), NUM(151,326) } }, // 151 
    { "nv",  FcCharSet{4, OFF(152,328), NUM(152,328) } }, // 152 
    { "ny",  FcCharSet{2, OFF(153,332), NUM(153,332) } }, // 153 
    { "oc",  FcCharSet{1, OFF(154,334), NUM(154,334) } }, // 154 
    { "om",  FcCharSet{1, OFF(155,87), NUM(155,87) } }, // 155 
    { "or",  FcCharSet{1, OFF(156,335), NUM(156,335) } }, // 156 
    { "os",  FcCharSet{1, OFF(157,279), NUM(157,279) } }, // 157 
    { "ota",  FcCharSet{1, OFF(158,336), NUM(158,336) } }, // 158 
    { "pa",  FcCharSet{1, OFF(159,337), NUM(159,337) } }, // 159 
    { "pa-pk",  FcCharSet{1, OFF(160,287), NUM(160,287) } }, // 160 
    { "pap-an",  FcCharSet{1, OFF(161,338), NUM(161,338) } }, // 161 
    { "pap-aw",  FcCharSet{1, OFF(162,339), NUM(162,339) } }, // 162 
    { "pl",  FcCharSet{2, OFF(163,340), NUM(163,340) } }, // 163 
    { "ps-af",  FcCharSet{1, OFF(164,342), NUM(164,342) } }, // 164 
    { "ps-pk",  FcCharSet{1, OFF(165,343), NUM(165,343) } }, // 165 
    { "pt",  FcCharSet{1, OFF(166,344), NUM(166,344) } }, // 166 
    { "qu",  FcCharSet{2, OFF(167,345), NUM(167,345) } }, // 167 
    { "quz",  FcCharSet{2, OFF(168,345), NUM(168,345) } }, // 168 
    { "rm",  FcCharSet{1, OFF(169,347), NUM(169,347) } }, // 169 
    { "rn",  FcCharSet{1, OFF(170,87), NUM(170,87) } }, // 170 
    { "ro",  FcCharSet{3, OFF(171,348), NUM(171,348) } }, // 171 
    { "ru",  FcCharSet{1, OFF(172,279), NUM(172,279) } }, // 172 
    { "rw",  FcCharSet{1, OFF(173,87), NUM(173,87) } }, // 173 
    { "sa",  FcCharSet{1, OFF(174,30), NUM(174,30) } }, // 174 
    { "sah",  FcCharSet{1, OFF(175,351), NUM(175,351) } }, // 175 
    { "sat",  FcCharSet{1, OFF(176,352), NUM(176,352) } }, // 176 
    { "sc",  FcCharSet{1, OFF(177,353), NUM(177,353) } }, // 177 
    { "sco",  FcCharSet{3, OFF(178,354), NUM(178,354) } }, // 178 
    { "sd",  FcCharSet{1, OFF(179,357), NUM(179,357) } }, // 179 
    { "se",  FcCharSet{2, OFF(180,358), NUM(180,358) } }, // 180 
    { "sel",  FcCharSet{1, OFF(181,279), NUM(181,279) } }, // 181 
    { "sg",  FcCharSet{1, OFF(182,360), NUM(182,360) } }, // 182 
    { "sh",  FcCharSet{3, OFF(183,361), NUM(183,361) } }, // 183 
    { "shs",  FcCharSet{2, OFF(184,364), NUM(184,364) } }, // 184 
    { "si",  FcCharSet{1, OFF(185,366), NUM(185,366) } }, // 185 
    { "sid",  FcCharSet{2, OFF(186,367), NUM(186,367) } }, // 186 
    { "sk",  FcCharSet{2, OFF(187,369), NUM(187,369) } }, // 187 
    { "sl",  FcCharSet{2, OFF(188,42), NUM(188,42) } }, // 188 
    { "sm",  FcCharSet{2, OFF(189,371), NUM(189,371) } }, // 189 
    { "sma",  FcCharSet{1, OFF(190,373), NUM(190,373) } }, // 190 
    { "smj",  FcCharSet{1, OFF(191,374), NUM(191,374) } }, // 191 
    { "smn",  FcCharSet{2, OFF(192,375), NUM(192,375) } }, // 192 
    { "sms",  FcCharSet{3, OFF(193,377), NUM(193,377) } }, // 193 
    { "sn",  FcCharSet{1, OFF(194,87), NUM(194,87) } }, // 194 
    { "so",  FcCharSet{1, OFF(195,87), NUM(195,87) } }, // 195 
    { "sq",  FcCharSet{1, OFF(196,380), NUM(196,380) } }, // 196 
    { "sr",  FcCharSet{1, OFF(197,381), NUM(197,381) } }, // 197 
    { "ss",  FcCharSet{1, OFF(198,87), NUM(198,87) } }, // 198 
    { "st",  FcCharSet{1, OFF(199,87), NUM(199,87) } }, // 199 
    { "su",  FcCharSet{1, OFF(200,118), NUM(200,118) } }, // 200 
    { "sv",  FcCharSet{1, OFF(201,382), NUM(201,382) } }, // 201 
    { "sw",  FcCharSet{1, OFF(202,87), NUM(202,87) } }, // 202 
    { "syr",  FcCharSet{1, OFF(203,383), NUM(203,383) } }, // 203 
    { "ta",  FcCharSet{1, OFF(204,384), NUM(204,384) } }, // 204 
    { "te",  FcCharSet{1, OFF(205,385), NUM(205,385) } }, // 205 
    { "tg",  FcCharSet{1, OFF(206,386), NUM(206,386) } }, // 206 
    { "th",  FcCharSet{1, OFF(207,387), NUM(207,387) } }, // 207 
    { "ti-er",  FcCharSet{2, OFF(208,45), NUM(208,45) } }, // 208 
    { "ti-et",  FcCharSet{2, OFF(209,367), NUM(209,367) } }, // 209 
    { "tig",  FcCharSet{2, OFF(210,388), NUM(210,388) } }, // 210 
    { "tk",  FcCharSet{2, OFF(211,390), NUM(211,390) } }, // 211 
    { "tl",  FcCharSet{1, OFF(212,86), NUM(212,86) } }, // 212 
    { "tn",  FcCharSet{2, OFF(213,326), NUM(213,326) } }, // 213 
    { "to",  FcCharSet{2, OFF(214,371), NUM(214,371) } }, // 214 
    { "tr",  FcCharSet{2, OFF(215,392), NUM(215,392) } }, // 215 
    { "ts",  FcCharSet{1, OFF(216,87), NUM(216,87) } }, // 216 
    { "tt",  FcCharSet{1, OFF(217,394), NUM(217,394) } }, // 217 
    { "tw",  FcCharSet{5, OFF(218,4), NUM(218,4) } }, // 218 
    { "ty",  FcCharSet{3, OFF(219,395), NUM(219,395) } }, // 219 
    { "tyv",  FcCharSet{1, OFF(220,284), NUM(220,284) } }, // 220 
    { "ug",  FcCharSet{1, OFF(221,398), NUM(221,398) } }, // 221 
    { "uk",  FcCharSet{1, OFF(222,399), NUM(222,399) } }, // 222 
    { "und-zmth",  FcCharSet{12, OFF(223,400), NUM(223,400) } }, // 223 
    { "und-zsye",  FcCharSet{12, OFF(224,412), NUM(224,412) } }, // 224 
    { "ur",  FcCharSet{1, OFF(225,287), NUM(225,287) } }, // 225 
    { "uz",  FcCharSet{1, OFF(226,87), NUM(226,87) } }, // 226 
    { "ve",  FcCharSet{2, OFF(227,424), NUM(227,424) } }, // 227 
    { "vi",  FcCharSet{4, OFF(228,426), NUM(228,426) } }, // 228 
    { "vo",  FcCharSet{1, OFF(229,430), NUM(229,430) } }, // 229 
    { "vot",  FcCharSet{2, OFF(230,431), NUM(230,431) } }, // 230 
    { "wa",  FcCharSet{1, OFF(231,433), NUM(231,433) } }, // 231 
    { "wal",  FcCharSet{2, OFF(232,367), NUM(232,367) } }, // 232 
    { "wen",  FcCharSet{2, OFF(233,434), NUM(233,434) } }, // 233 
    { "wo",  FcCharSet{2, OFF(234,436), NUM(234,436) } }, // 234 
    { "xh",  FcCharSet{1, OFF(235,87), NUM(235,87) } }, // 235 
    { "yap",  FcCharSet{1, OFF(236,438), NUM(236,438) } }, // 236 
    { "yi",  FcCharSet{1, OFF(237,108), NUM(237,108) } }, // 237 
    { "yo",  FcCharSet{4, OFF(238,439), NUM(238,439) } }, // 238 
    { "za",  FcCharSet{1, OFF(239,87), NUM(239,87) } }, // 239 
    { "zh-cn",  FcCharSet{82, OFF(240,443), NUM(240,443) } }, // 240 
    { "zh-hk",  FcCharSet{171, OFF(241,525), NUM(241,525) } }, // 241 
    { "zh-mo",  FcCharSet{171, OFF(242,525), NUM(242,525) } }, // 242 
    { "zh-sg",  FcCharSet{82, OFF(243,443), NUM(243,443) } }, // 243 
    { "zh-tw",  FcCharSet{83, OFF(244,696), NUM(244,696) } }, // 244 
    { "zu",  FcCharSet{1, OFF(245,87), NUM(245,87) } }, // 245 
},
[...]FcCharLeaf{
    { /* 0 */
...
const NUM_LANG_CHAR_SET = 246 
const NUM_LANG_SET_MAP	= 8 

var fcLangCountrySets = [][NUM_LANG_SET_MAP]uint32 {
