...
type Drawer interface {
	...
	SetSourceRgba(red, green, blue, alpha fl)
	...
	// see `ArcNegative` to get the arc
	...
	Arc(xc, yc, radius, angle1, angle2 fl)
	...
	// TODO
	UserToDevice(fl, fl) (fl, fl)
	UserToDeviceDistance(fl, fl) (fl, fl)
	DeviceToUser(fl, fl) (fl, fl)
	DeviceToUserDistance(fl, fl) (fl, fl)
}
