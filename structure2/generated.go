...
func NewBoxFields(elementTag string, style tree.StyleFor, children []Box) *BoxFields {
	out := BoxFields{
...
func NewParentBox(elementTag string, style tree.StyleFor, children []Box) *ParentBox {
	out := ParentBox{}
...
func NewBlockLevelBox(elementTag string, style tree.StyleFor, children []Box) *BlockLevelBox {
	out := BlockLevelBox{}
...
func NewBlockContainerBox(elementTag string, style tree.StyleFor, children []Box) *BlockContainerBox {
...
func NewBlockBox(elementTag string, style tree.StyleFor, children []Box) *BlockBox {
	out := BlockBox{}
...
func NewInlineLevelBox(elementTag string, style tree.StyleFor, children []Box) *InlineLevelBox {
	out := InlineLevelBox{}
...
func NewInlineBox(elementTag string, style tree.StyleFor, children []Box) *InlineBox {
	out := InlineBox{}
...
func NewAtomicInlineLevelBox(elementTag string, style tree.StyleFor, children []Box) *AtomicInlineLevelBox {
...
func NewInlineBlockBox(elementTag string, style tree.StyleFor, children []Box) *InlineBlockBox {
	out := InlineBlockBox{}
...
func NewReplacedBox(elementTag string, style tree.StyleFor, replacement tree.ImageType) *ReplacedBox {
	out := ReplacedBox{
...
func ReplacedBoxAnonymousFrom(parent Box, nil tree.ImageType) *ReplacedBox {
	return NewReplacedBox(parent.Box().elementTag, parent.Box().style.InheritFrom(), nil)
}
func (b ReplacedBox) Copy() Box { return &b }

func NewBlockReplacedBox(elementTag string, style tree.StyleFor, replacement tree.ImageType) *BlockReplacedBox {
	out := BlockReplacedBox{}
	parent := NewReplacedBox(elementTag, style, replacement)
	out.ReplacedBox = *parent
	return &out
}
func BlockReplacedBoxAnonymousFrom(parent Box, replacement tree.ImageType) *BlockReplacedBox {
...
func NewInlineReplacedBox(elementTag string, style tree.StyleFor, replacement tree.ImageType) *InlineReplacedBox {
	out := InlineReplacedBox{}
	parent := NewReplacedBox(elementTag, style, replacement)
	out.ReplacedBox = *parent
	return &out
}
func InlineReplacedBoxAnonymousFrom(parent Box, replacement tree.ImageType) *InlineReplacedBox {
...
func NewTableBox(elementTag string, style tree.StyleFor, children []Box) *TableBox {
	out := TableBox{
...
func NewInlineTableBox(elementTag string, style tree.StyleFor, children []Box) *InlineTableBox {
	out := InlineTableBox{}
...
func NewTableRowGroupBox(elementTag string, style tree.StyleFor, children []Box) *TableRowGroupBox {
...
func NewTableRowBox(elementTag string, style tree.StyleFor, children []Box) *TableRowBox {
	out := TableRowBox{
		properTableChild:       true,
		internalTableOrCaption: true,
		tabularContainer:       true,
...
func NewTableColumnGroupBox(elementTag string, style tree.StyleFor, children []Box) *TableColumnGroupBox {
...
func NewTableColumnBox(elementTag string, style tree.StyleFor, children []Box) *TableColumnBox {
	out := TableColumnBox{
		properTableChild:       true,
		internalTableOrCaption: true,
		span:                   1,
...
func NewTableCellBox(elementTag string, style tree.StyleFor, children []Box) *TableCellBox {
	out := TableCellBox{
		internalTableOrCaption: true,
		colspan:                1,
		rowspan:                1,
...
func NewTableCaptionBox(elementTag string, style tree.StyleFor, children []Box) *TableCaptionBox {
	out := TableCaptionBox{
		properTableChild:       true,
		internalTableOrCaption: true,
	}
